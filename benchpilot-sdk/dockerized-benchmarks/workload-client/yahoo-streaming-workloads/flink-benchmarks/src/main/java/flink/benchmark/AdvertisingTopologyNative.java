...
public class AdvertisingTopologyNative {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        int bufferTimeout = ((Number)conf.get("flink.buffer.timeout")).intValue();
        int checkpointInterval = ((Number)conf.get("flink.checkpoint.interval")).intValue();
        int partitions =  ((Number)conf.get("flink.partitions")).intValue();
        ...
        DataStream<String> messageStream = env
                .addSource(new FlinkKafkaConsumer<String>(
                        ...
                        flinkBenchmarkParams.getProperties())).setParallelism(partitions);
