...
(defn write-to-kafka [ads kafka-hosts kafka-event-count]
...
(defn check-correct [redis-host time-divisor]
  (let [stats (doall (dostats time-divisor))]
    (println "Got stats!")
